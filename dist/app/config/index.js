...
exports.default = {
    ...
    trust_proxy: process.env.TRUST_PROXY && Number.isFinite(Number(process.env.TRUST_PROXY))
    ...
    vapid: {
        ...
        private_key: process.env.VAPID_PRIVATE_KEY || '_Fldrvo_OnijFNQiOKqWR2zl2M2ZEbUSL5UDYFBNyJc',
