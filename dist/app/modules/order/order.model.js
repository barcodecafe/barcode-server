...
const selectedAddonSchema = new mongoose_1.Schema({
...
const orderSchema = new mongoose_1.Schema({
    ...
    pickupBranchId: { type: mongoose_1.Schema.Types.Mixed, default: null },
    pickupBranchName: { type: String, default: '' },
    regionId: { type: Number, default: null }, // ordering region (region-based delivery)
    branchId: { type: mongoose_1.Schema.Types.Mixed, default: null }, // optional — legacy / future branch routing
    paymentMethod: { type: String, default: 'cod' },
    paymentStatus: { type: String, enum: order_interface_1.PAYMENT_STATUSES, default: 'Pending' }, // server-controlled
    ...
    toJSON: {
        transform(_doc, ret) {
            var _a;
            ret.id = (_a = ret._id) === null || _a === void 0 ? void 0 : _a.toString(); // frontend order id = ObjectId hex (non-enumerable)
            delete ret._id;
            delete ret.__v;
            return ret;
        },
