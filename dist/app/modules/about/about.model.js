...
const subTransform = {
    ...
    transform(_doc, ret) {
        var _a;
        ret.id = (_a = ret._id) === null || _a === void 0 ? void 0 : _a.toString(); // stable id (array index নয় — #4.10)
        delete ret._id;
        return ret;
    },
};
...
const aboutSchema = new mongoose_1.Schema({
    ...
    heroDescription: {
        type: String,
        default: 'From a single kitchen to six thriving branches, Barcode has stayed true to one core philosophy: every dish should meet the exact same culinary standard. Every single time. Everywhere.',
    },
    ...
    storyDescription: {
        type: String,
        default: 'On a fine afternoon in 2013, our journey began with a simple dream: a place where friends could relax over freshly brewed coffee and exceptional food. Today, Barcode Restaurant Group has evolved into a beloved multi-brand culinary family, honoring traditional heritage while pioneering modern dining across Bangladesh.',
    },
