...
router.put(
  '/reorder',
  ...adminOnly,
  validateRequest(reorderFoodsValidationSchema),
  FoodController.reorderFoodsController
);
router.put(
  '/categories/reorder',
  ...adminOnly,
  validateRequest(reorderCategoriesValidationSchema),
  FoodController.reorderCategoriesController
);
...
router.post(
  '/',
  ...adminOnly,
  validateRequest(createFoodValidationSchema),
  FoodController.createFoodController
);
router.patch(
  '/:id',
  ...adminOnly,
  validateRequest(updateFoodValidationSchema),
